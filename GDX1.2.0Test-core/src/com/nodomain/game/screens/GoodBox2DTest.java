...
public class GoodBox2DTest extends InputAdapter implements Screen {
    ...
    public GoodBox2DTest(Game game)
    {
        this.game = game;
...
*/
    ...
    private Body createCircle(BodyType type, float radius, float density) {
        ...
        circle.createFixture(poly, density);
        poly.dispose();
    ...
    public boolean keyUp(int keycode) {
        ...
        if (keycode == Keys.A || keycode == Keys.D)
        {
            ...
            //player.setLinearVelocity( 0.0f, player.linVelLoc.y );
        }
