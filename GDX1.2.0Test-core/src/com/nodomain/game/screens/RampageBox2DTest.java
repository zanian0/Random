...
public class RampageBox2DTest implements Screen
{
    ...
    public RampageBox2DTest(Game game)
    {
        this.game = game;
    ...
    private void input()
    {
        ...
        if (moveX == 0)
        {
            playerForce = box.getLinearVelocity();
            playerForce.x = 0.0f;
            box.applyForceToCenter( playerForce, true );
